    ...
    <div className="py-32">
      <div className="max-w-7xl mx-auto px-6">
        <div className="relative mx-auto max-w-6xl">
                ...
                {showcaseMedia.map((media, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className={`relative z-10 inline-flex items-center gap-2 ${isActive ? 'text-black' : ''}`}>
                        <span className={`h-1.5 w-1.5 rounded-full ${isActive ? 'bg-black/45' : 'bg-black/30'}`} />
                        {media.label}
                      </span>
                    </button>
                  );
          ...
          <div
            className="relative mx-auto max-w-5xl rounded-3xl bg-[#f7f6f3] p-2 shadow-[0_10px_30px_rgba(0,0,0,0.07)]"
