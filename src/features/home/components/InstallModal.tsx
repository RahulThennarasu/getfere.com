            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full p-12 relative">
              ...
              <div className="grid grid-cols-3 gap-8 mb-8">
                ...
                <div className="text-center">
                  ...
                  >
                    open{" "}
                    <span className="text-black font-medium">fere.dmg</span>{" "}
                    from your{" "}
                ...
                <div className="text-center">
                  ...
                  >
                    drag the{" "}
                    <span className="text-black font-medium">fere icon</span>{" "}
                    into your{" "}
                    <span className="text-black font-medium">applications</span>{" "}
                    folder
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  >
                    open the{" "}
                    <span className="text-black font-medium">fere</span> app
                    from your{" "}
                    <span className="text-black font-medium">applications</span>{" "}
                    folder
                  </p>
